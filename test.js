...
export default function Home({navigation}) {
  ...
  const [names, setNames] = useState([
    {id: '1', callerId: 'tinith', },
    {id: '2', callerId: 'umanda', },
    {id: '3', callerId: 'promo', },
    {id: '4', callerId: 'tharaka', },
    {id: '5', callerId: 'dinusha', },
 ...
 const [video , setVideo] = useState({})
  ...
  const clientCheck = async () => {
    ...
    if (loginData) {
      const temPusers = names.filter(name => name.callerId != loginData.user)
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        {names.map(name => (
          <TouchableOpacity
            ...
            <Text style={styles.contactName}>{name.callerId}</Text>
          </TouchableOpacity>
        ))}
      </ScrollView>
